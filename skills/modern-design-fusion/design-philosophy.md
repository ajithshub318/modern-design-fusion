...
> **Attribution**: This document is adapted from Anthropic's `frontend-design`
> skill, redistributed under Apache 2.0. Original at
> https://github.com/anthropics/claude-code. See `NOTICE` for full attribution.

This reference is loaded by the `modern-design-fusion` orchestrator whenever a
task has an aesthetic dimension. It tells Claude *how* to design — the
companion `INDEX.md` + `guides/` tell Claude *what APIs to build with*.
...
- **Tone**: Pick an extreme — brutally minimal, maximalist chaos,
  ...
  industrial/utilitarian, etc. Use these for inspiration but design one that
...
frontend's aesthetics — unexpected, characterful font choices. Pair a
...
Create atmosphere and depth rather than defaulting to solid colors. Add
contextual effects and textures that match the overall aesthetic. Apply
...
- Predictable layouts: 3-column card grids, evenly-spaced everything
- Cookie-cutter design that lacks context-specific character
- Default convergence on common choices (e.g., always Space Grotesk)
...
themes, different fonts, different aesthetics. NEVER converge on common
...
Remember: extraordinary creative work is possible. Don't hold back; show what
